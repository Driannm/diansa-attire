...
const CollectionsPage = () => {
  const kebayaDummy = [
    ...
    },
    {
      ...
      badge: "Best Seller",
      imageUrl:
        "/images/wisuda-raja-gagak-putri-napal-melintang-kebaya-in-cerulean-blue.webp",
    },
    {
    ...
    },
    {
      ...
      badge: "Top Bulan Ini",
      imageUrl:
        "/images/wisuda-dua-putri-raja-ular-kebaya-in-powder-pink-on-periwinkle.webp",
    },
    {
      ...
      category: "Wisuda",
      imageUrl:
        "/images/wisuda-pesut-mahakam-kebaya-in-dusty-pink-on-dust-blue.webp",
    },
    {
      ...
      badge: "Rekomendasi Admin",
      imageUrl:
        "/images/wisuda-putri-mandalika-kebaya-in-ombre-dusty-pink.webp",
    },
    {
  ...
  return (
    <div className="min-h-screen px-6 md:px-12 py-12">
      ...
      <p className="text-base sm:text-lg text-gray-600 text-center dark:text-gray-400 max-w-2xl mx-auto mb-8">
        Jelajahi berbagai pilihan kebaya elegan dengan sentuhan modern dan
        tradisional. Temukan desain yang sempurna untuk momen spesial Anda -
        dari lamaran, wisuda, hingga pernikahan.
      </p>
